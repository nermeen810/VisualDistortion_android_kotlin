...
class ServiceDetailsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            sliderDataArrayList = arrayListOf(
                SliderData(service.beforeImg, "الصورة قبل المهمة"),
    ...
    private fun init() {
        ...
        binding.serviceNumValue.text =
            Constants.convertNumsToArabic(service.serviceNumber.toString())
    ...
    private fun navToQrCode(qrCodeUrl: String?) {
        val action = ServiceDetailsFragmentDirections.actionServiceDetailsToQrCode(
            qrCodeUrl ?: "",
            "history"
        )
